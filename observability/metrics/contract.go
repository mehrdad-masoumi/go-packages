...
const (
	...
	MessagingUnroutableTotal     = "messaging_unroutable_total"
	MessagingConfirmTimeoutTotal = "messaging_confirm_timeout_total"
	OutboxPendingTotal           = "outbox_pending_total"
	OutboxFailedTotal            = "outbox_failed_total"
	OutboxExhaustedTotal         = "outbox_exhausted_total"
	...
	ConsumerDuplicateTotal       = "consumer_duplicate_total"
	ReconciliationMismatchTotal  = "reconciliation_mismatch_total"
	ReconciliationRepairedTotal  = "reconciliation_repaired_total"
	ReconciliationScannedTotal   = "reconciliation_scanned_total"
	ReconciliationFailedTotal    = "reconciliation_failed_total"
	AmbiguousOperationsTotal     = "ambiguous_operations_total"
	CircuitBreakerState          = "circuit_breaker_state"
	CircuitBreakerTransitions    = "circuit_breaker_transitions_total"
	ClientFailuresTotal          = "service_client_failures_total"
	ClientRetriesTotal           = "service_client_retries_total"
	ClientTimeoutsTotal          = "service_client_timeouts_total"
	ClientGiveUpTotal            = "service_client_give_up_total"
